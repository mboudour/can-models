...
The locally served Streamlit application was inspected in a browser. The default workspace displayed:
...
The ledger visibly identifies the executed Study 2 sample preparation and joint network, pending Study 2 diagnostic/group/country outputs, restricted Study 1, and access-gated cross-study comparison.
...
## Post-cleanup interface validation

**Validated locally:** 2026-08-19

The top-level selector displayed exactly two workspaces: **Abadi et al. Study 2 replication** and **Bring your own data**. The default replication view retained the original-data scope, four source metrics, replication ledger, and data/code access tab without missing assets. The BYOD view retained the return-to-replication control, data upload, YAML mapping restore, optional study-design selector, and Quick mode control. No discontinued workspace, source data, metrics, or navigation option was present.
