...
The repository’s worked example is a genuine **public Study 2 replication workspace** based on the authors’ original April 2020 four-country dataset. It is not an adaptation using a different topic or survey. Study 1 remains explicitly access-gated because the original 15-country 2019 data are restricted under the article’s H2020/GDPR data-availability statement.
...
The 2019 15-country Study 1 data are not bundled. The paper says that they are restricted by H2020 GDPR agreements and directs access requests to the corresponding author. The Streamlit application includes a request template and a required-materials checklist. Until access is granted, the repository does not simulate Study 1 results, a cross-study NCT, or the paper’s two-study conclusions.
