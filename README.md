...
The repository centres on a genuine **public Study 2 replication workspace** based on the Abadi et al. authors’ original April 2020 four-country dataset. It also provides a completed **ESS CRONOS-3 Wave 6 / SoGreen Green Transition Attitude Network worked case**: the public repository and app host source links, a 21-node cross-national protocol, pooled and country-level derived results, and reproducibility safeguards, while the official ESS microdata remain local. A third **CCAM December 2024 Climate-Engagement Feasibility Case** is included transparently: its verified source and derived results are available, but its near-complete networks fail the project’s non-saturation gate and are not presented as publication-ready CAN findings. Study 1 remains explicitly access-gated because the original 15-country 2019 data are restricted under the article’s H2020/GDPR data-availability statement.
...
| **CCAM December 2024 feasibility case** | A source-cited, locally reproducible 15-node climate-engagement **feasibility case**. Its primary and sensitivity networks are near-complete, so it is displayed to audit a failed non-saturation gate rather than as a substantive or publication-ready CAN result; the public app does not host CCAM microdata. |
...
The third case uses the public [Climate Change in the American Mind 2008–2024 archive](https://osf.io/jw79p/) from the Yale Program on Climate Change Communication and George Mason University Center for Climate Change Communication. Its Terms of Use permit scholarly analysis but prohibit redistributing respondent-level records. The local source file therefore remains in `data/external/ccam_2008_2024/`; the public repository contains only the configuration, source checksum, derived non-row-level outputs, and transparent feasibility documentation.

The pre-specified 15-node December 2024 system connects climate belief and attribution, anticipated risk, transition-policy support, and climate communication. It uses 995 complete cases but retains 102 of 105 possible conditional associations (density 0.971). A stricter EBIC model remains density 0.895, and smaller theory-led systems remain density 0.964–1.000. Accordingly, no centrality, edge, or causal interpretation is offered. See [docs/ccam_dec2024_feasibility_case.md](docs/ccam_dec2024_feasibility_case.md).
